...
@section('container')
    ...
    <div class="col-lg-8">
        <form method="POST" action="/dashboard/akreditasi/{{ $akreditasi->id }}">
            @method('put')
            @csrf
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('status_peringkat') is-invalid @enderror"
                    id="status_peringkat" name="status_peringkat" required autofocus
                    value="{{ old('status_peringkat', $akreditasi->status_peringkat) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('doktor_jumlah') is-invalid @enderror"
                        id="doktor_jumlah" name="doktor_jumlah" required autofocus
                        value="{{ old('doktor_jumlah', $akreditasi->doktor_jumlah) }}">
                    @error('doktor_jumlah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('doktor_persentase') is-invalid @enderror"
                        ...
                        value="{{ old('doktor_persentase', $akreditasi->doktor_persentase) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('magister_jumlah') is-invalid @enderror"
                        id="magister_jumlah" name="magister_jumlah" required autofocus
                        value="{{ old('magister_jumlah', $akreditasi->magister_jumlah) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('magister_persentase') is-invalid @enderror"
                        ...
                        value="{{ old('magister_persentase', $akreditasi->magister_persentase) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('sarjana_jumlah') is-invalid @enderror"
                        id="sarjana_jumlah" name="sarjana_jumlah" required autofocus
                        value="{{ old('sarjana_jumlah', $akreditasi->sarjana_jumlah) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('sarjana_persentase') is-invalid @enderror"
                        ...
                        value="{{ old('sarjana_persentase', $akreditasi->sarjana_persentase) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('profesi_jumlah') is-invalid @enderror"
                        id="profesi_jumlah" name="profesi_jumlah" required autofocus
                        value="{{ old('profesi_jumlah', $akreditasi->profesi_jumlah) }}">
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('profesi_persentase') is-invalid @enderror"
                        ...
                        value="{{ old('profesi_persentase', $akreditasi->profesi_persentase) }}">
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('total_jumlah') is-invalid @enderror" id="total_jumlah"
                        name="total_jumlah" required autofocus
                        value="{{ old('total_jumlah', $akreditasi->total_jumlah) }}">
                    @error('total_jumlah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('total_persentase') is-invalid @enderror"
                        ...
                        value="{{ old('total_persentase', $akreditasi->total_persentase) }}">
